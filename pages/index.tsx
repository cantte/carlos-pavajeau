        ...
        <div className="w-full mt-20">
          <Section delay={0.2}>
            ...
            <p className="mx-auto mt-4 text-lg font-medium text-gray-400 lg:max-w-3xl lg:text-xl lg:text-center">
              ...
              applications. With knowledge in the field of software development,
              I have a strong background in languages such as Java, JavaScript,
              TypeScript, C#, and Python. Also, I have experience with the
              following technologies: Angular, React, Node.js, Asp.Net, Docker,
              Kubernetes, PosgreSQL, MySQL. I am currently learning React
              Native.
            </p>
          </Section>
        </div>
